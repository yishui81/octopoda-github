...
//  Ptr<ProxyMutex> mutex;
  DList(HttpStateMachine, debug_link) sm_list;
};
...
private:
  ...
  void dump_tunnel_info(HttpStateMachine * sm);
  void dump_history(HttpStateMachine * sm);
  int dump_sm(HttpStateMachine * sm);
