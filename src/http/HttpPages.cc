...
void
HttpPagesHandler::dump_tunnel_info(HttpStateMachine * sm)
{
...
void
HttpPagesHandler::dump_history(HttpStateMachine * sm)
{
...
int
HttpPagesHandler::dump_sm(HttpStateMachine * sm)
{
